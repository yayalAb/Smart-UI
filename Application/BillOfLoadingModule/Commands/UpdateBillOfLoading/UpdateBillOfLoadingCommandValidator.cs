...
{
    public class UpdateBillOfLoadingCommandValidator : AbstractValidator<UpdateBillOfLoadingCommand>    
    {
        private readonly IAppDbContext _context;
        public UpdateBillOfLoadingCommandValidator(IAppDbContext context)
        {
            _context = context;
