...
namespace Application.Common.Interfaces
{
    public  interface IIdentityService
    {
        ...
        Task<(Result result, string userId)> createUser(string fullName, string userName, string email, string password, int addressId, int groupId);
        ...
        Task<Result> UpdateUser(int id, string fullName, string userName, string email, int groupId);
    }
}
